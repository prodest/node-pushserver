...
export class PushController {
    ...
    public getUsers(req: Request, res: Response) {
        return this.repository
            .getDistinctUsersBySub(req.query.f)
            .then((ids: any[]) => ({ users: ids }));
    }
    ...
    public getUserAssociations(req: Request, res: Response) {
        return this.repository
            .getForId(req.params.sub)
            .then((associations: any[]) => ({ associations: associations }));
    }
    ...
    public subscribe(req: any, res: Response) {
        const association = {
            sub: req.user.subNovo ? req.user.subNovo : req.user.sub,
            subLegacy: req.user ? req.user.sub : null,
            type: req.body.type,
    ...
    public delete(req: Request, res: Response) {
        return this.repository.removeUser(req.params.sub);
    }
