...
export class PushRouter {
    ...
    public routers() {
        ...
        this.router.delete('/users/:user', AuthenticationService.basicAuthentication, (req: Request, res: Response, next: NextFunction) => this.respond(this.controller.delete(req, res), res, next));
