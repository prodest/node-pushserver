...
app = authentication.initialize(app);
...
// Main API
app.post('/subscribe', authentication.validateSecret, function (req, res) {
...
app.post('/unsubscribe', authentication.validateSecret, function (req, res) {
    var data = req.body;
...
// Utils API
app.get('/users/:user/associations', authentication.ensureAuthenticated, function (req, res) {
...
exports.start = function () {
    pathApp.listen(config.get('webPort'));
